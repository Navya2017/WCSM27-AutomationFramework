...
/**
 * This class provides implementation for the ITestListener interface for TestNG
 * @author A
 */
...
public class ListenersImplementation implements ITestListener {
	...
	public void onStart(ITestContext context) {
		...
		ExtentSparkReporter(".\\ExtentReports\\Report-"+new
		JavaUtility().getSystemDateInFormat()+".html");
